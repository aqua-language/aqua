use runtime_macros::Send;
use runtime_macros::Share;
use runtime_macros::Sync;
use runtime_macros::Unpin;
use serde::Deserialize;
use serde::Serialize;

use runtime_traits::Share;

#[derive(
    Share, Clone, Send, Sync, Unpin, Serialize, Deserialize, Eq, PartialEq, Hash, Ord, PartialOrd,
)]
#[repr(C)]
pub struct Cow<T>(pub std::rc::Rc<T>);

impl<T: std::fmt::Debug> std::fmt::Debug for Cow<T> {
