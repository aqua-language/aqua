...
use crate::common::desugar_program;
use crate::common::expr_int;
use crate::common::expr_unit;
use crate::common::parse_program;
...
fn test_desugar_dot() {
    ...
    let b = parse_program("a.b();").unwrap();
    check!(a, b);
}
...
fn test_desugar_int_suffix() {
    ...
    let b = parse_program("suffix_s(10)").unwrap();
    check!(a, b);
}
...
fn test_desugar_float_suffix() {
    ...
    let b = parse_program("suffix_s(1.0)").unwrap();
    check!(a, b);
}
